...
// CODE HERE
function helloStyleChange(event){
    sayHelloButton.style.backgroundColor = "black"
    sayHelloButton.style.color = "white"
}
sayHelloButton.addEventListener('mouseover', helloStyleChange)
// PROBLEM 3
/*
...
// CODE HERE
function helloStyleChangeBack(event){
    sayHelloButton.style.backgroundColor = "#EFEFEF"
    sayHelloButton.style.color = "black"
}
sayHelloButton.addEventListener('mouseout', helloStyleChangeBack)
...
// let repeatText = document.querySelector('#repeat-text').textContent
